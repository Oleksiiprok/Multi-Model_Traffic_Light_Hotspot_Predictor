...
# Riverside, Illinois, USA
# Updated: Exactly 10 Major Traffic Light Intersections per Village
#Original file is located at
    #https://colab.research.google.com/drive/1p4V5y2yMKpqD8GZ3lXAh8OBUvvnA5Drf
"""
...
# Output widgets definition
out_map = widgets.Output(layout={'width': '100%', 'height': '350px', 'border': '2px solid #2980b9'})
...
# Stable map rendering inside Output container
def render_stable_map(out_widget, map_obj):
    with out_widget:
        clear_output(wait=True)
        display(HTML(f'<div style="width:100%; height:330px;">{map_obj._repr_html_()}</div>'))

# Dictionary containing exactly 10 major traffic light intersections for each village
regions_data = {
    "Riverside": [
        {"name": "Longcommon Rd & E Burlington St", "lat": 41.8295, "lon": -87.8182},
        {"name": "Riverside Rd & Bloomingbank Rd", "lat": 41.8312, "lon": -87.8225},
        {"name": "First Ave & 31st St", "lat": 41.8385, "lon": -87.8341},
        ...
        {"name": "Harlem Ave & E Quincy St", "lat": 41.8285, "lon": -87.8052},
        {"name": "31st St & Golf Rd", "lat": 41.8360, "lon": -87.8250},
        {"name": "First Ave & Ogden Ave", "lat": 41.8195, "lon": -87.8340},
        {"name": "Harlem Ave & Addison Rd", "lat": 41.8220, "lon": -87.8052}
    ],
    "Brookfield": [
        ...
        {"name": "8th Ave & Ogden Ave", "lat": 41.8200, "lon": -87.8385},
        {"name": "1st Ave & 47th St", "lat": 41.8080, "lon": -87.8340},
        {"name": "Prairie Ave & 31st St", "lat": 41.8355, "lon": -87.8460}
    ],
    "North Riverside": [
        ...
        {"name": "5th Ave & Cermak Rd", "lat": 41.8520, "lon": -87.8250},
        {"name": "9th Ave & Cermak Rd", "lat": 41.8520, "lon": -87.8185},
        {"name": "26th St & 1st Ave", "lat": 41.8440, "lon": -87.8340}
    ],
    "La Grange": [
        ...
        {"name": "Ogden Ave & La Grange Rd", "lat": 41.8160, "lon": -87.8710},
        {"name": "Brainard Ave & 47th St", "lat": 41.8065, "lon": -87.8590},
        {"name": "Hillgrove Ave & La Grange Rd", "lat": 41.8140, "lon": -87.8710}
    ],
    "Berwyn": [
        ...
        {"name": "16th St & Oak Park Ave", "lat": 41.8590, "lon": -87.7925},
        {"name": "26th St & Oak Park Ave", "lat": 41.8440, "lon": -87.7925},
        {"name": "Ogden Ave & Oak Park Ave", "lat": 41.8210, "lon": -87.7925},
        {"name": "Windsor Ave & Harlem Ave", "lat": 41.8400, "lon": -87.8050}
    ],
    "Lyons": [
        ...
        {"name": "1st Ave & 43rd St", "lat": 41.8140, "lon": -87.8340},
        {"name": "1st Ave & Riverside Dr", "lat": 41.8270, "lon": -87.8340},
        {"name": "Joliet Ave & Lawndale Ave", "lat": 41.8050, "lon": -87.8230},
        {"name": "Ogden Ave & White Ave", "lat": 41.8220, "lon": -87.8290},
        {"name": "47th St & 1st Ave", "lat": 41.8080, "lon": -87.8340}
    ],
    "Willowbrook": [
        {"name": "Kingery Hwy & 75th St", "lat": 41.7502, "lon": -87.9575},
        {"name": "Plainfield Rd & Clarendon Hills Rd", "lat": 41.7550, "lon": -87.9650},
        {"name": "Frontage Rd & Madison St", "lat": 41.7460, "lon": -87.9500},
        {"name": "79th St & Kingery Hwy", "lat": 41.7430, "lon": -87.9600},
        {"name": "Hinsdale Rd & 71st St", "lat": 41.7610, "lon": -87.9520},
        {"name": "63rd St & Kingery Hwy", "lat": 41.7800, "lon": -87.9575},
        {"name": "Plainfield Rd & Madison St", "lat": 41.7600, "lon": -87.9500},
        {"name": "75th St & Madison St", "lat": 41.7502, "lon": -87.9500},
        {"name": "83rd St & Kingery Hwy", "lat": 41.7350, "lon": -87.9575},
        {"name": "Frontage Rd & Route 83", "lat": 41.7460, "lon": -87.9575}
    ],
    "Westmont": [
        {"name": "Cass Ave & 63rd St", "lat": 41.7800, "lon": -87.9770},
        {"name": "Ogden Ave & Cass Ave", "lat": 41.8100, "lon": -87.9770},
        {"name": "63rd St & Fairview Ave", "lat": 41.7800, "lon": -87.9550},
        {"name": "Cass Ave & 55th St", "lat": 41.7920, "lon": -87.9770},
        {"name": "Ogden Ave & Fairview Ave", "lat": 41.8120, "lon": -87.9550},
        {"name": "65th St & Cass Ave", "lat": 41.7760, "lon": -87.9770},
        {"name": "Ogden Ave & Adams St", "lat": 41.8100, "lon": -87.9700},
        {"name": "63rd St & Manning Rd", "lat": 41.7800, "lon": -87.9680},
        {"name": "Cass Ave & 59th St", "lat": 41.7860, "lon": -87.9770},
        {"name": "55th St & Fairview Ave", "lat": 41.7920, "lon": -87.9550}
    ],
    "Darien": [
        {"name": "Cass Ave & 75th St", "lat": 41.7500, "lon": -87.9800},
        {"name": "Plainfield Rd & Cass Ave", "lat": 41.7560, "lon": -87.9780},
        {"name": "75th St & Lemont Rd", "lat": 41.7500, "lon": -88.0030},
        {"name": "83rd St & Plainfield Rd", "lat": 41.7350, "lon": -87.9850},
        {"name": "Cass Ave & 87th St", "lat": 41.7230, "lon": -87.9800},
        {"name": "Crest Rd & 75th St", "lat": 41.7500, "lon": -87.9700},
        {"name": "75th St & Lyman Ave", "lat": 41.7500, "lon": -87.9900},
        {"name": "83rd St & Cass Ave", "lat": 41.7350, "lon": -87.9800},
        {"name": "73rd St & Lemont Rd", "lat": 41.7530, "lon": -88.0030},
        {"name": "Plainfield Rd & Bailey Rd", "lat": 41.7610, "lon": -87.9900}
    ],
    "Evanston": [
        {"name": "Davis St & Sherman Ave", "lat": 42.0468, "lon": -87.6870},
        {"name": "Chicago Ave & Dempster St", "lat": 42.0390, "lon": -87.6830},
        {"name": "Central St & Green Bay Rd", "lat": 42.0630, "lon": -87.6950},
        {"name": "Ridge Ave & Main St", "lat": 42.0330, "lon": -87.6830},
        {"name": "Ridge Ave & Howard St", "lat": 42.0190, "lon": -87.6830},
        {"name": "Dodge Ave & Dempster St", "lat": 42.0390, "lon": -87.7000},
        {"name": "Asbury Ave & Main St", "lat": 42.0330, "lon": -87.6920},
        {"name": "Central St & Ridge Ave", "lat": 42.0630, "lon": -87.6830},
        {"name": "Green Bay Rd & Dempster St", "lat": 42.0390, "lon": -87.6900},
        {"name": "Evanston Ave & Emerson St", "lat": 42.0500, "lon": -87.6850}
    ],
    "Oak Park": [
        {"name": "Lake St & Harlem Ave", "lat": 41.8880, "lon": -87.8050},
        {"name": "North Ave & Austin Blvd", "lat": 41.9100, "lon": -87.7740},
        {"name": "Oak Park Ave & Madison St", "lat": 41.8780, "lon": -87.7920},
        {"name": "Roosevelt Rd & Harlem Ave", "lat": 41.8660, "lon": -87.8050},
        {"name": "Madison St & Austin Blvd", "lat": 41.8780, "lon": -87.7740},
        {"name": "Lake St & Oak Park Ave", "lat": 41.8880, "lon": -87.7920},
        {"name": "North Ave & Oak Park Ave", "lat": 41.9100, "lon": -87.7920},
        {"name": "Roosevelt Rd & Oak Park Ave", "lat": 41.8660, "lon": -87.7920},
        {"name": "Garfield St & Harlem Ave", "lat": 41.8730, "lon": -87.8050},
        {"name": "Madison St & Ridgeland Ave", "lat": 41.8780, "lon": -87.7840}
    ],
    "Naperville": [
        {"name": "Washington St & 5th Ave", "lat": 41.7780, "lon": -88.1530},
        {"name": "Ogden Ave & Naper Blvd", "lat": 41.7820, "lon": -88.1250},
        {"name": "75th St & Route 59", "lat": 41.7500, "lon": -88.2030},
        {"name": "Washington St & 75th St", "lat": 41.7500, "lon": -88.1530},
        {"name": "Ogden Ave & Washington St", "lat": 41.7820, "lon": -88.1530},
        {"name": "95th St & Route 59", "lat": 41.7230, "lon": -88.2030},
        {"name": "Naper Blvd & 75th St", "lat": 41.7500, "lon": -88.1250},
        {"name": "Aurora Ave & Washington St", "lat": 41.7710, "lon": -88.1530},
        {"name": "87th St & Naper Blvd", "lat": 41.7350, "lon": -88.1250},
        {"name": "5th Ave & Route 59", "lat": 41.7780, "lon": -88.2030}
    ]
}
...
# Interactive prediction and update logic with Model Comparison details
def update_dashboard(region, algorithm, period, intersection_idx, hour, day_of_week, temperature, precipitation, traffic_flow, is_roadwork):
    ...
    if algorithm == 'XGB':
        ...
        pros = "High predictive accuracy, handles complex non-linear feature interactions efficiently."
        cons = "Higher risk of overfitting on small samples, less intuitive interpretation."
    elif algorithm == 'RF':
        model = RandomForestClassifier(n_estimators=100, max_depth=5, random_state=42)
        pros = "Strong robustness against noise and outliers, great performance on tabular datasets."
        cons = "Bulky model size, slower inference time compared to simpler linear models."
    else:
        model = make_pipeline(StandardScaler(), LogisticRegression(max_iter=1000, random_state=42))
        pros = "High speed, simple and clear interpretation, great baseline for linear trends."
        cons = "Unable to capture complex non-linear feature interactions independently."
    ...
    report_html = f"""
    <div style="background-color: #f8f9fa; padding: 8px; border-left: 4px solid #007bff; border-radius: 4px; font-family: sans-serif; font-size: 12px;">
        <h5 style="margin: 0 0 4px 0; color: #333; font-size: 13px;">📊 AI Traffic Analysis & Model Insights</h5>
        <ul style="margin: 0; padding-left: 16px; color: #444; line-height: 1.4;">
            <li><b>Suburb / Intersection:</b> {region} - {selected_loc['name']}</li>
            <li><b>Selected AI Model:</b> <code>{algo_name}</code> | <b>Period:</b> {period_labels[period]}</li>
            <li><b>Hotspot Probability:</b> <span style="color: {'red' if probability > 60 else ('orange' if probability > 30 else 'green')}; font-weight: bold; font-size: 13px;">{probability:.1f}%</span></li>
            <hr style="margin: 4px 0; border: 0; border-top: 1px solid #ddd;">
            <li><b>Model Pros:</b> {pros}</li>
            <li><b>Model Cons:</b> {cons}</li>
            <li><b>AI Application:</b> Evaluates intersection congestion risks to optimize dynamic traffic light scheduling.</li>
        </ul>
    </div>
    """
    with out_report:
    ...
    # Create map centered specifically on the selected intersection's lat/lon
...
model_dropdown = widgets.Dropdown(options=[('XGBoost (High Accuracy)', 'XGB'), ('Random Forest (Robust)', 'RF'), ('Logistic Regression (Fast)', 'LR')], value='XGB', description='AI Algorithm:', style={'description_width': desc_width}, layout={'width': widget_width})
...
# Connect widgets using interactive_output
...
# Adapted Layout Design: Left sidebar (Controls + Report), Right side (Map)
left_controls = widgets.VBox([
    widgets.HTML("<b style='color:#2c3e50;'>⚙️ Control Panel & AI Config</b>"),
    region_dropdown,
    model_dropdown,
    period_dropdown,
    ...
    out_report
], layout={'width': '405px', 'padding': '5px', 'border_right': '1px solid #ddd'})

right_display = widgets.VBox([
    widgets.HTML("<b style='color:#2c3e50;'>🗺️ Hotspot Map</b>"),
    out_map
], layout={'width': 'calc(100% - 410px)', 'padding': '5px'})

main_layout = widgets.HBox([left_controls, right_display], layout={'width': '100%'})

display(widgets.VBox([
    widgets.HTML("<h3 style='margin: 0 0 10px 0; color: #2c3e50;'>Multi-Model Traffic Light Hotspot Predictor</h3>"),
    main_layout
]))